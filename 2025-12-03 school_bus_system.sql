...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2025 at 11:22 PM
...
--
-- Dumping data for table `bus_records`
--

INSERT INTO `bus_records` (`id`, `bus_id`, `conductor_id`, `direction`, `status`, `timestamp`, `student`, `actvity_type`, `current_load`, `time_start`, `time_end`) VALUES
(1, 2, 3, 'INBOUND', 'IDLE', '2025-03-11 17:27:22', NULL, NULL, NULL, '2025-03-12 01:27:22', '2025-03-12 02:03:15'),
(2, 2, 3, 'OUTBOUND', 'IDLE', '2025-03-11 18:06:12', NULL, NULL, NULL, '2025-03-12 02:06:12', '2025-03-12 02:06:22'),
(3, 2, 3, 'INBOUND', 'IDLE', '2025-03-11 18:06:47', NULL, NULL, NULL, '2025-03-12 02:06:47', '2025-03-12 02:10:19'),
(4, 2, 3, 'INBOUND', 'ONGOING', '2025-03-11 21:44:15', NULL, NULL, NULL, '2025-03-12 05:44:15', NULL);
...
INSERT INTO `students` (`id`, `name`, `student_id`, `status`) VALUES
(1, 'Andrei Zacarias', 1, 'ACTIVE'),
(4, 'Student A', 2, 'ACTIVE'),
(5, 'Student B', 3, 'ACTIVE'),
(6, 'Student C', 4, 'ACTIVE'),
(7, 'Student D', 5, 'ACTIVE'),
(8, 'Student E', 6, 'ACTIVE'),
(9, 'Student F', 7, 'ACTIVE');
...
INSERT INTO `student_logs` (`id`, `session_id`, `student_id`, `pick_up_time`, `drop_off_time`, `status`) VALUES
(1, 4, 4, '2025-03-12 05:44:58', '2025-03-12 06:00:07', 'DROPPED OFF');
