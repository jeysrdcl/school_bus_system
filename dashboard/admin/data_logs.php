...
<body>
    ...
    <div class="content">
        <h1>Data Logs</h1>
        <p style="font-size: 18px; color: #fff; font-weight: bold;">View and manage system data logs.</p>
        <div class="message-box">
            <p style="color: #000 !important;">This is where data logs will be displayed.</p>
        </div>
    </div>
